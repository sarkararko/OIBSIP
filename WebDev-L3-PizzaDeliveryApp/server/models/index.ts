...
export const INITIAL_INVENTORY = [
  ...
  { id: 'veg_cherry_tomatoes', name: 'Sun-ripened Cherry Tomatoes', category: 'vegetable', stock: 70, threshold: 20, unit: 'portions', price: 29, isVeg: true, description: 'Sweet blistered heirloom cherry tomatoes burst with juiciness.' },
  { id: 'veg_kalamata_olives', name: 'Greek Kalamata Black Olives', category: 'vegetable', stock: 65, threshold: 20, unit: 'portions', price: 39, isVeg: true, description: 'Pitted, plump Mediterranean olives cured in red wine vinegar.' },
  { id: 'veg_caramelized_onions', name: 'Balsamic Caramelized Onions', category: 'vegetable', stock: 50, threshold: 15, unit: 'portions', price: 29, isVeg: true, description: 'Slow-cooked sweet Spanish onions glazed with Modena balsamic.' },
  { id: 'veg_wild_mushrooms', name: 'Truffle-Glazed Wild Mushrooms', category: 'vegetable', stock: 45, threshold: 15, unit: 'portions', price: 49, isVeg: true, description: 'Medley of cremini, shiitake and oyster mushrooms sautéed in thyme.' },
  { id: 'veg_bell_peppers', name: 'Charred Tricolor Bell Peppers', category: 'vegetable', stock: 60, threshold: 20, unit: 'portions', price: 29, isVeg: true, description: 'Crisp red, yellow and green bell peppers fire-roasted for natural sweetness.' },
  { id: 'veg_pickled_jalapenos', name: 'Spicy Escabeche Jalapeños', category: 'vegetable', stock: 55, threshold: 18, unit: 'portions', price: 29, isVeg: true, description: 'Crisp hand-pickled jalapeño wheels with a fiery zesty bite.' },
  { id: 'veg_marinated_artichokes', name: 'Tuscan Marinated Artichoke Hearts', category: 'vegetable', stock: 35, threshold: 12, unit: 'portions', price: 59, isVeg: true, description: 'Tender Italian artichoke quarters soaked in oregano infused oil.' },
  { id: 'veg_baby_spinach', name: 'Organic Tender Baby Spinach', category: 'vegetable', stock: 50, threshold: 15, unit: 'portions', price: 25, isVeg: true, description: 'Farm-fresh organic baby greens wilted gently in oven heat.' }
];
...
export const INITIAL_PIZZAS = [
  {
    ...
    base: 'base_sourdough',
    sauce: 'sauce_san_marzano',
    cheese: 'cheese_mozzarella',
    vegetables: ['veg_cherry_tomatoes'],
  ...
  },
  {
    ...
    rating: 4.95,
    badge: 'Award Winner',
    base: 'base_gluten_free',
    sauce: 'sauce_creamy_garlic_alfredo',
    cheese: 'cheese_smoked_scamorza',
    vegetables: ['veg_wild_mushrooms', 'veg_baby_spinach'],
  ...
  },
  {
    ...
    sauce: 'sauce_san_marzano',
    cheese: 'cheese_gorgonzola',
    vegetables: ['veg_caramelized_onions'],
  ...
  },
  {
    ...
    sauce: 'sauce_basil_pesto',
    cheese: 'cheese_burrata',
    vegetables: ['veg_cherry_tomatoes', 'veg_kalamata_olives', 'veg_marinated_artichokes'],
  ...
  },
  {
    ...
    cheese: 'cheese_vegan_cashew',
    vegetables: ['veg_bell_peppers', 'veg_pickled_jalapenos', 'veg_caramelized_onions'],
    defaultCrust: 'base_sourdough',
  ...
  },
  {
    ...
    rating: 4.88,
    badge: 'Heavyweight',
    base: 'base_pan_deep_dish',
    sauce: 'sauce_san_marzano',
    cheese: 'cheese_mozzarella',
    vegetables: ['veg_wild_mushrooms', 'veg_bell_peppers', 'veg_kalamata_olives'],
        ...
        if (!Array.isArray(this.data.pizzas) || this.data.pizzas.length === 0) {
          ...
          this.data.pizzas = this.data.pizzas.map((p: any) => {
            ...
            return {
              ...
              base: p.base || p.defaultCrust || initial?.base || 'base_sourdough',
              sauce: p.sauce || p.defaultSauce || initial?.sauce || 'sauce_san_marzano',
              cheese: p.cheese || p.defaultCheese || initial?.cheese || 'cheese_mozzarella',
              vegetables: p.vegetables || p.defaultVeggies || initial?.vegetables || ['veg_cherry_tomatoes'],
              defaultCrust: p.defaultCrust || p.base || initial?.defaultCrust || 'base_sourdough',
              defaultSauce: p.defaultSauce || p.sauce || initial?.defaultSauce || 'sauce_san_marzano',
              defaultCheese: p.defaultCheese || p.cheese || initial?.defaultCheese || 'cheese_mozzarella',
              defaultVeggies: p.defaultVeggies || p.vegetables || initial?.defaultVeggies || ['veg_cherry_tomatoes'],
            };
          });
        }
        this.saveToDisk();
